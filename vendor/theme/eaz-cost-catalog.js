...
(function (global) {
  ...
  var CATALOG = [
    ...
    { feature: 'bg_remove', labelKey: 'eazCostBgRemove', labelDefault: 'Remove background' },
    { feature: 'design_edit', labelKey: 'eazCostDesignEdit', labelDefault: 'Edit design' },
    { feature: 'design_variation', labelKey: 'eazCostDesignVariation', labelDefault: 'Design variation' },
    { feature: 'mockup_generate', labelKey: 'eazCostMockupGenerate', labelDefault: 'Generate mockup' },
    { feature: 'mockup_save', labelKey: 'eazCostMockupSave', labelDefault: 'Save mockup' },
